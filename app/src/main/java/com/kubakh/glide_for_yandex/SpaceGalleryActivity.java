...
public class SpaceGalleryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //установка адаптера для активити
    ...
    private class ImageGalleryAdapter extends RecyclerView.Adapter<ImageGalleryAdapter.MyViewHolder>  {
        ...
        public void onBindViewHolder(ImageGalleryAdapter.MyViewHolder holder, int position) {
            ...
            //запускаем прогрузку и отрисовку всех картинок
            Glide.with(mContext)
        ...
        public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            //открытие картинки в новом активити. взаимодействие двух активити через Intent
            @Override
